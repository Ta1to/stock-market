//utility functions for calculating technical indicators from stock data
export const calculateRSI = (prices, period = 14) => {
  ...
  // estimate trading volume based on price and market cap
  ...
  export const calculateAllIndicators = (stockData) => {
    ...
    console.log('Calculating indicators with currentPrice:', currentPrice);
